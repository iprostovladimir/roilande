...
!(function (e, t) {
  ...
  var o = function (e, t) {
    ...
    n = function (e) {
      ...
      (t = e),
        ...
        (d = t.clientWidth - o),
        e.querySelector(u).parentNode === e
          ? e.querySelector(u).offsetWidth
          : 0,
        (c = q(e) + m.offsetPixels),
        (y = ((r = document),
        (i = window),
        (a =
  ...
  p.doesItFit = function (t) {
    ...
    0,
      ((o = function () {
        ...
        for (
          n(t);
          (d <= c && 0 < t.querySelector(s).children.length) ||
          (y < m.breakPoint && 0 < t.querySelector(s).children.length);

        )
          p.toDropdown(t, e),
            n(t),
            y < m.breakPoint && b(t, e, m.navDropdownBreakpointLabel);
        for (; d >= v[e][v[e].length - 1] && y > m.breakPoint; )
          p.toMenu(t, e), y > m.breakPoint && b(t, e, m.navDropdownLabel);
        v[e].length < 1 &&
          (t.querySelector(u).classList.remove("show"),
          b(t, e, m.navDropdownLabel)),
          t.querySelector(s).children.length < 1
            ? (t.classList.add("is-empty"),
              b(t, e, m.navDropdownBreakpointLabel))
  ...
  (p.toDropdown = function (e, t) {
    e.querySelector(u).firstChild && 0 < e.querySelector(s).children.length
      ? e
          .querySelector(u)
          .insertBefore(
            e.querySelector(s).lastElementChild,
            e.querySelector(u).firstChild
          )
      : 0 < e.querySelector(s).children.length &&
        e.querySelector(u).appendChild(e.querySelector(s).lastElementChild),
      v[t].push(c),
      g(e, t),
      0 < e.querySelector(s).children.length && m.count && r(e, t),
      m.moved();
  }),
    (p.toMenu = function (e, t) {
      0 < e.querySelector(u).children.length &&
        e.querySelector(s).appendChild(e.querySelector(u).firstElementChild),
        v[t].pop(),
        g(e, t),
        0 < e.querySelector(s).children.length && m.count && r(e, t),
        m.movedBack();
  ...
  var q = function (e) {
      for (var t = e.childNodes, n = 0, o = 0; o < t.length; o++)
        3 !== t[o].nodeType &&
          (isNaN(t[o].offsetWidth) || (n += t[o].offsetWidth));
      return n;
    },
    L = function (t, n) {
      window.attachEvent
        ...
        t.querySelector(a).addEventListener("click", function () {
          o(t.querySelector(u), "show"),
            o(this, "is-open"),
            o(t, "is-open"),
            -1 !== t.className.indexOf("is-open")
              ? t.querySelector(u).setAttribute("aria-hidden", "false")
              : (t.querySelector(u).setAttribute("aria-hidden", "true"),
                t.querySelector(u).blur());
        }),
        ...
        (document.onkeydown = function (e) {
          27 === (e = e || window.event).keyCode &&
            (document.querySelector(u).classList.remove("show"),
    ...
    (p.init = function (e) {
      ...
      if (
        ...
        if (N(m.navDropdownClassName) && N(m.navDropdownToggleClassName)) {
          ...
          S(t, function (e) {
            var t, n;
            ((v[f] = []), e.setAttribute("instance", f++), (i = e))
              ? ((s = m.mainNav),
                e.querySelector(s)
                  ? ((t = e),
                    (n = m),
                    ...
                    ((a = document.createElement("button")).innerHTML =
                      n.navDropdownLabel),
                    a.setAttribute("aria-controls", "Все"),
                    a.setAttribute("type", "button"),
                    u.setAttribute("aria-hidden", "true"),
                    t.querySelector(s).parentNode === t
                      ? (t.insertAfter(l, t.querySelector(s)),
                        l.appendChild(a),
                        l.appendChild(u),
                        u.classList.add(n.navDropdownClassName),
                        u.classList.add("priority-nav__dropdown"),
                        a.classList.add(n.navDropdownToggleClassName),
                        a.classList.add("priority-nav__dropdown-toggle"),
                        a.setAttribute("type", "button"),
                        l.classList.add(n.navDropdownClassName + "-wrapper"),
                        l.classList.add("priority-nav__wrapper"),
                        t.classList.add("priority-nav"))
                      : console.warn(
                          "mainNav is not a direct child of mainNavWrapper, double check please"
                        ),
                    (u = "." + m.navDropdownClassName),
                    e.querySelector(u)
...
// function updateWatcherView() {
//   const blockSection = document.querySelector(".block");
//   const mainSection = document.querySelector(".main");
//   const footerSection = document.querySelector(".footer");

//   if (
//     mainSection.classList.contains("_watcher-view") ||
//     footerSection.classList.contains("_watcher-view")
//   ) {
//     blockSection.classList.add("_watcher-view01");
//   } else {
//     blockSection.classList.remove("_watcher-view01");
//   }
// }

// const blockSection = document.querySelector(".block");
// const footerSection = document.querySelector(".footer");
// if (blockSection && footerSection) {
...
const contentSlider = document.querySelector(".js-content-sliderTwo");

if (contentSlider) {
  const mediaQuery = window.matchMedia("(max-width: 992px)");
  function handleMediaQuery(mediaQuery) {
    if (mediaQuery.matches && window.innerWidth <= 992) {
      contentSlider.removeAttribute("dir");
    } else {
      contentSlider.setAttribute("dir", "ltr");
    }
  }

  // Вызываем функцию handleMediaQuery при загрузке страницы
  handleMediaQuery(mediaQuery);

  // Регистрируем обработчик на изменения медиа-запроса
...
// const priceSidebar = document.querySelector(".price__sidebar");
// const priceSidebarBody = document.querySelector(".sidebar--price__body");
...
//         priceSidebar.removeAttribute("data-sticky");
//         priceSidebarBody.removeAttribute("data-sticky-item");
//         priceSidebarBody.style.removeProperty("display");
//       }
//     }
...
if (caseBlock) {
  const block = caseBlock.querySelector(".block");

  document.addEventListener("DOMContentLoaded", function () {
    window.addEventListener("scroll", function () {
      if (
        window.scrollY >= caseBlock.offsetTop &&
        window.scrollY <=
          caseBlock.offsetTop + caseBlock.offsetHeight - block.offsetHeight
      ) {
...
const priceBlock = document.querySelector(".price__sidebar");

if (priceBlock) {
  const block = priceBlock.querySelector(".sidebar--price__body");

  document.addEventListener("DOMContentLoaded", function () {
    window.addEventListener("scroll", function () {
      if (
        window.scrollY >= priceBlock.offsetTop &&
        window.scrollY <=
          priceBlock.offsetTop + priceBlock.offsetHeight - block.offsetHeight
      ) {
        block.style.position = "fixed";
      } else {
        block.style.position = "absolute";
